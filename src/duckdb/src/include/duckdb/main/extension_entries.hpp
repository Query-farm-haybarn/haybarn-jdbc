...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"ducklake_commit", "ducklake", CatalogType::TABLE_FUNCTION_ENTRY},
    ...
    {"iceberg_bucket", "iceberg", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"iceberg_column_stats", "iceberg", CatalogType::TABLE_FUNCTION_ENTRY},
    {"iceberg_load_table_response", "iceberg", CatalogType::TABLE_FUNCTION_ENTRY},
    ...
    {"quack_query_by_name", "quack", CatalogType::TABLE_FUNCTION_ENTRY},
    {"quack_serve", "quack", CatalogType::TABLE_FUNCTION_ENTRY},
    {"quack_server_list", "quack", CatalogType::TABLE_FUNCTION_ENTRY},
    {"quack_stop", "quack", CatalogType::TABLE_FUNCTION_ENTRY},
    {"quack_uri_parser", "quack", CatalogType::SCALAR_FUNCTION_ENTRY},
    ...
    {"whoami", "quack", CatalogType::TABLE_MACRO_ENTRY},
...
static constexpr ExtensionEntry EXTENSION_SETTINGS[] = {
    ...
    {"ducklake_target_file_size", "ducklake"},
    ...
    {"whoami_meta", "quack"},
    {"whoami_name", "quack"},
    {"whoami_provider", "quack"},
    {"whoami_region", "quack"},
    {"whoami_started_at", "quack"},
...
static constexpr ExtensionEntry EXTENSION_SECRET_TYPES[] = {
    ...
    {"quack", "quack"},          {"r2", "httpfs"},
    {"rds", "postgres_scanner"}, {"s3", "httpfs"},
    {"uc", "unity_catalog"},     {"unity_catalog", "unity_catalog"},
