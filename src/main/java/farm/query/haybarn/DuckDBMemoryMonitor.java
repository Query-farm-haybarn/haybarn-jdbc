 ...
 * via the {@value HaybarnDriver#JDBC_JFR_MEMORY_MONITOR} connection property; that value
 ...
 * give each one a unique {@value HaybarnDriver#JDBC_JFR_MEMORY_MONITOR} value.
 *
 * <h2>Thread safety</h2>
...
final class DuckDBMemoryMonitor {
     ...
     * and called from {@link HaybarnDriver}'s static initializer so that recordings
     ...
     * {@link HaybarnDriver} from loading.
     */
