...
import static farm.query.haybarn.DuckDBBindings.*;
import static farm.query.haybarn.DuckDBBindings.CAPIType.DUCKDB_TYPE_INTEGER;
import static farm.query.haybarn.TestDuckDBJDBC.JDBC_URL;
...
public class TestScalarFunctions {
    ...
    public static void test_register_scalar_function_registry_records_registered_functions() throws Exception {
        HaybarnDriver.clearFunctionsRegistry();
        try (Connection conn = DriverManager.getConnection(JDBC_URL); Statement stmt = conn.createStatement()) {
            RegisteredFunction function = DuckDBFunctions.scalarFunction()
            ...
            List<RegisteredFunction> registeredFunctions = HaybarnDriver.registeredFunctions();
    ...
    public static void test_register_scalar_function_registry_clear_only_clears_java_registry() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(JDBC_URL); Statement stmt = conn.createStatement()) {
            ...
            assertEquals(HaybarnDriver.registeredFunctions().size(), 1);
            HaybarnDriver.clearFunctionsRegistry();
            assertEquals(HaybarnDriver.registeredFunctions().size(), 0);
    ...
    public static void test_register_scalar_function_registry_allows_duplicate_names() throws Exception {
        ...
        String urlA = "jdbc:haybarn:" + dbPathA.toAbsolutePath();
        String urlB = "jdbc:haybarn:" + dbPathB.toAbsolutePath();
